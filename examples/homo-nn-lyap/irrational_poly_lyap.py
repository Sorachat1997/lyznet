...
net, model_path = lyznet.neural_learner(
    system, lr=0.001, num_colloc_pts=300000, max_epoch=5, layer=1, width=10, 
    loss_mode="Homo_Lyapunov", net_type="Poly")


c1_V, c2_V = lyznet.neural_verifier(system, net, 
                                    net_type="Poly", verifier="Homo")


lyznet.plot_V(system, net, model_path, c1_V=0.001, c2_V=0.01, phase_portrait=True)
